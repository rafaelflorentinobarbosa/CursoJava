...
INSERT INTO tb_cliente (cpf, nome, endereco, email) 
...
INSERT INTO tb_funcionario (nome, funcao, email)
...
INSERT INTO tb_fornecedor (cnpj, nome, telefone, endereco) 
...
INSERT INTO tb_produto (preco, validade, nome, descricao, quantidade, cnpj_fornecedor) VALUES
...
INSERT INTO tb_venda(matricula_funcionario, cpf_cliente)
...
INSERT INTO tb_venda_produto(id_venda, codigo_produto, quantidade_vendido)
VALUES	(10000, 106, 2),
		(10000, 104, 1),
        (10001, 106, 3),
        (10002, 100, 5),
...
SELECT * FROM db_papelaria.tb_cliente;